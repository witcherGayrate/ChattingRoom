...
MessageTextEdit::MessageTextEdit(QWidget *parent):QTextEdit(parent)
{
    ...
    //connect(this,&MessageTextEdit::send,this,&MessageTextEdit::slot_edit_sendmsg);//enter快捷键
}
...
{
    //qDebug()<<"drag event occured"<<Qt::endl;
...
{
    //qDebug()<<"drop event occured"<<Qt::endl;
